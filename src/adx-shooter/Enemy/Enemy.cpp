...
void Enemy::AddBullet() {
	...
	Bullet* newBullet = Shoot_Pattern_Single_Shot::Shoot(mEntity, 1, 50);
...
{
	Bullet* newLineBullet = Shoot_Pattern_Line::Shoot(mEntity, mStats.mStrength, 10, 1, GameManager::GetInstance().GetWindow(), 1);
